...
var ActionUI = function (exports) {
  ...
  class Store {
    ...
    modelCreate(type, id = null, data = null) {
      ...
      if (!this._model[type]) {
        ...
        _data._type = type;
        this._model[type] = new Model(_data, {
          model: this._model,
          property: type
        });
      ...
      if (id != null && ('string' == typeof id || 'number' == typeof id) && !this._model[type][id]) {
        data = data || {};
        data._type = type;
        this._model[type][id] = new Model(data, {
          model: this._model[type],
          property: id
        });
    ...
    actionHandler(type, method, resolve, reject, data) {
      ...
      return promise.then(json => resolve(json)).catch(error => reject(error));
    }
    data(json) {
    ...
    urlCache(url, model = null, json = null) {
      ...
      if (json) for (let _key of this.options.keysExcludeFromCache) delete json[_key];
      return this._urlCache[url] = {
        url: url,
        type: type,
        model: model,
    ...
    static cache(store) {
      ...
      if ('string' == typeof store) {
        ...
        if (_cache$1[store] != undefined) return _cache$1[store];
  ...
  class StoreJsonApi extends Store {
    ...
    mapRelationship(type, id, relationType, relationId) {
      ...
      if (this._mapRelationships[type][id][relationType].indexOf(relationId) == -1) this._mapRelationships[type][id][relationType].push(relationId);
  ...
  class ViewFile extends View {
    ...
    fetchBefore() {
      ...
      document.querySelectorAll('[ui-view="' + this._name + '"]').forEach(target => {
