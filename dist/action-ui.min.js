...
o.url+=(0>o.url.indexOf("?")?"?":"&")+Object.keys(t).map(e=>e+"="+t[e]).join("&"));else if(e.attributes.enctype&&"application/json"==e.attributes.enctype.value)o.body=JSON.stringify(t);else{let e=new FormData;for(let o in t)e.append(o,t[o]);o.body=e}this.handler=new Request(o.url,o)}n=fetch(this.handler).then(e=>e.json().then(t=>e.ok?t:Promise.reject(t)))}return n.then(o=>this.after(e,!0,o,t),o=>this.after(e,!1,o,t))}syncModel(e){return e=t({},e,!0),g.verbose&&console.info("Action.syncModel()",this.name,{action:this,data:e}),e instanceof Object||(e={result:e}),this.model.sync&&this.model.sync instanceof Function?this.model.sync(e):this.model instanceof Object&&t(this.model,e),e}before(e,t){g.verbose&&console.info("Action.before()",this.name,{action:this,target:e,data:t}),c.setCssClass(e,g.cssClass.loading,t),c.reflectCssClass(this.name,g.cssClass.loading,t);let o=new CustomEvent(g.eventBefore.type,g.eventBefore);return Object.assign(o.detail,{name:this.name,data:t,model:this.model}),e.dispatchEvent(o)}after(e,t,o,n){g.verbose&&console.info("Action.after()",this.name,{action:this,target:e,data:n,success:t,result:o}),this.running=!1;var a=o instanceof u,i=t?g.cssClass.success:g.cssClass.fail;a&&(i=g.cssClass.canceled),c.setCssClass(e,i,n),c.reflectCssClass(this.name,i,n),null==o||o instanceof Error||this.syncModel(o);let s=new CustomEvent(g.eventAfter.type,g.eventAfter);return Object.assign(s.detail,{name:this.name,success:t,data:n,model:this.model,error:!!(o instanceof Error)&&o,canceled:a}),e.dispatchEvent(s),o}// #region Static methods
// Initialize the action cache and top-level event listener (only once)
static init(){document.addEventListener("click",t=>{let e=s(t.target,"[ui-action]");if(e&&"FORM"!=e.tagName&&!e.disabled&&!t.target.disabled){"INPUT"==e.tagName&&("checkbox"==e.type||"radio"==e.type)||t.preventDefault();var o=e.getAttribute("ui-action");// Don't run the action if it's already running
if(o in y)!1==y[o].running&&y[o].run(e);else if(g.autoCreate){// Auto create and run action
var n=c.createFromElement(e);c.cache(n),n.run(e)}else throw new Error("Action not found: "+o)}}),document.addEventListener("submit",t=>{if(t.target.matches("form[ui-action]")&&!t.target.disabled){t.preventDefault();var e=t.target.getAttribute("ui-action");// Don't run the action if it's already running
if(e in y)!1==y[e].running&&y[e].run(t.target);else if(g.autoCreate){// Auto create and run action
var o=c.createFromElement(t.target);c.cache(o),o.run(t.target)}else throw new Error("Action not found: "+e)}})}static create(e,t=!0){if(g.verbose&&console.info(this.name+":create()",{options:e,fromCache:t}),!1=="name"in e)throw"No action name specfied";return!1=="handler"in e&&(!0=="url"in e&&e.url?e.handler=new Request(e.url,e.request||{}):e.handler=null),t?this.cache(e.name)||new this(e.name,e.handler,e.model):new this(e.name,e.handler,e.model)}static createFromElement(e,t={}){return c.create(Object.assign({name:e.getAttribute("ui-action")||null,url:e.action||e.href||t.href||null,request:{method:e.method||t.method||"GET"}},t))}// Cache an action 
static cache(e){return null==e?y:"string"==typeof e?y[e]:e.name in y?this:(y[e.name]=e,this)}static data(e){var t=e.dataset||{},o=n(e);return o&&(t=r(o,t)),t}static get(e){return y[e]}static setCssClass(e,t,o=null){if(!e.attributes["ui-nostate"]){if(null!=o&&!!e.attributes["ui-state-data"]){let t=!0,n=JSON.parse(e.attributes["ui-state-data"].value);for(let e in n)if(t=o[e]==n[e],!1===t)break;if(!1==t)return}for(var n in g.cssClass)e.classList.remove(g.cssClass[n]);e.classList.add(t)}}// Propagate class to all reflectors (ui-state and form submit buttons)
static reflectCssClass(e,t,o=null){document.querySelectorAll("form[ui-action=\""+e+"\"] [type=\"submit\"], form[ui-action=\""+e+"\"] button:not([type]), [ui-state=\""+e+"\"]").forEach(e=>c.setCssClass(e,t,o))}static get options(){return g}static set options(e){t(g,e)}// #endregion
	 ...
	 */class m{constructor(e){this.view=e}__autoload(){return this.view.render()}__error(){return this.view.render()}get view(){return this._view}set view(e){this._view=e}}/**
	 * JsonApi
	 ...
	 */class h{constructor(e){// Accept an array of store keys
...
for(var t in f)if(t.startsWith(e))return f[t];return}var o=e.options.baseUrl.toLowerCase();return o in f?this:(f[o]=e,this)}}let f={};/**
	 ...
	 */class _{constructor(e,t,o){o instanceof l||(o=new l(o||{controller:null,data:{},dev:!1,error:null,method:null,path:null,view:null})),this._name=e,this._html=t,this._model=o,o.watch(e=>this.update(e)),this.constructor.options.autoCache&&_.cache(this)}clear(){return document.querySelectorAll("[ui-view=\""+this._name+"\"]").forEach(e=>{e.innerHTML=""}),this}// When the model updates
...
return o&&t&&"string"==typeof o.callback&&(o=this.match(o.callback)),o}static navigate(t,o={},n=null){A.verbose&&console.info("Router.navigate()",{router:this,route:t,data:o});let a=this.sanitizePath(t),s=a[0],r=a[1],p=this.controllerName(s),d={data:o},l=this.match(t,!1);if(l&&"string"==typeof l.callback)// Redirect
return this.navigate(l.callback,o,n);this.controllers[p]||(s=A.defaultController,p=this.controllerName(s),r="/"==t?A.defaultMethod:a[0]),E[p]||(this.controllers[p]?E[p]=new this.controllers[p](this.view):E[p]=new m(this.view)),r=r||A.defaultMethod;let u=null,y=s+A.pathSeparator+r,g=i(r);E[p].view instanceof C?E[p].view.file=y:E[p].view instanceof w&&(E[p].view.html=y),A.autoload&&!(E[p][g]instanceof Function)&&(g=A.autoloadMethod),d.dev=location.host==A.devHost,d.view=y,d.controller=s,d.method=r,d.path=Array.from(a),d.event=n;// Query string to object
let h=location.search.substring(1);h&&(h=JSON.parse("{\""+decodeURI(h).replace(/"/g,"\\\"").replace(/&/g,"\",\"").replace(/=/g,"\":\"")+"\"}"),d.search=h);try{let e=Array.from(a);if(e.shift(),e.shift(),e.push(h),e.push(o),!l)E[p].view.model.clear().sync(d).clearChanges(),u=E[p][g].apply(E[p],e),this.pushState(t,{controller:s,method:r,data:Object.assign({},o),search:h});else if(l.callback instanceof c){l.callback.model.clear().sync(d).clearChanges();let e=n?n.target:document;u=l.callback.run(e,o)}else e.push(d),u=l.callback.apply(E[p],e)}catch(n){this.options.verbose&&console.error("Routing Error",n),this.pushState(t,{controller:s,method:r,data:Object.assign({},o),search:h}),u=this.handleError(p,d,a)}if(u instanceof Promise){let t=document.querySelectorAll("[ui-view=\""+this.view.name+"\"]");this.handleLoading(t,!0),u.then(()=>this.handleLoading(t,!1)).catch(o=>{throw this.handleLoading(t,!1),this.handleError(p,d,a,o),o})}return u}static handleLoading(e,t){return t?e.forEach(e=>e.classList.add(A.cssClass.loading)):e.forEach(e=>e.classList.remove(A.cssClass.loading)),this}static handleError(e,t,o,n){return t.error=n,t.view=t.controller+A.pathSeparator+A.errorView,t.path=o.join(A.pathSeparator),E[e].view instanceof C?E[e].view.file=(A.useControllerErrorViews?t.controller+A.pathSeparator:"")+A.errorView:E[e].view.html="Error loading "+t.path,E[e].view.model.clear().sync(t).clearChanges(),E[e][A.errorMethod]()}static sanitizePath(e){for(let t in A.verbose&&console.info("Router.sanitizePath()",{router:this,path:e}),"string"==typeof e&&(e=e.split("/"),e.shift(),e[0]=e[0]||A.defaultController),e)e[t]=(e[t]+"").toLowerCase();return 1==e.length&&e.push(A.defaultMethod),e}static controllerName(e){return A.verbose&&console.info("Router.controllerName()",{router:this,name:e}),a(i(e))+"Controller"}static pushState(e,o={}){location.pathname!=e&&(o.route=e,t(this.state,o),history.pushState(this.state,null,e))}static onClick(t){"A"==t.target.tagName&&t.target.pathname&&(t.preventDefault(),this.navigate(t.target.pathname,Object.assign({},t.target.dataset),t))}static onPopState(t){A.verbose&&console.info("Router.changeState()",{router:this,event:t});let e=location.pathname,o={};t.state&&(e=t.state.route,o=t.state.data),this.navigate(e,o)}// #region Properties
