...
}function c(a){return"FORM"==a.tagName?a:a.form}function d(a){return a[0].toUpperCase()+a.substr(1).toLowerCase()}function e(a){return a.toLowerCase().replace(/[^a-zA-Z0-9]+(.)/g,function(a,b){return b.toUpperCase()})}function f(a,b){return null==a||a.matches(b)?a:f(a.parentElement,b)}function g(a){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return c=Object.assign(Object.fromEntries(new FormData(a)),c),Object.entries(c).map(function(a){var d=a[0].split("[").map(function(a){return a.replace(/]/g,"")});if(1<d.length){var e=h(d,a[1]);b(c,e),delete c[a[0]]}return a}),c}function h(a,b,c){var d=a.pop();if(!d)return c;var e={};return e[d]=c?c:b,h(a,b,e)}var i=/*#__PURE__*/Object.freeze({__proto__:null,deepAssign:b,deepCopy:function(a,c){return b(a,c,!0)},requestFromElement:function(a){return new Request(a.action||options.href||null,{method:a.method||null})},form:c,capitalize:d,camelCase:e,firstMatchingParentElement:f,formToObject:g}),j=/*#__PURE__*/function(){//static __instance = 0
...
f.url+=(0>f.url.indexOf("?")?"?":"&")+Object.keys(d).map(function(a){return a+"="+d[a]}).join("&"));else if(b.attributes.enctype&&"application/json"==b.attributes.enctype.value)f.body=JSON.stringify(d);else{var h=new FormData;for(var i in d)h.append(i,d[i]);f.body=h}this.handler=new Request(f.url,f)}e=fetch(this.handler).then(function(a){return a.json().then(function(b){return a.ok?b:Promise.reject(b)})})}return e.then(function(a){return c.after(b,!0,a,d)},function(a){return c.after(b,!1,a,d)})}},{key:"syncModel",value:function syncModel(a){return a=b({},a,!0),m.verbose&&console.info("Action.syncModel()",this.name,{action:this,data:a}),a instanceof Object||(a={result:a}),this.model.sync&&this.model.sync instanceof Function?this.model.sync(a):this.model instanceof Object&&b(this.model,a),a}},{key:"before",value:function before(b,c){m.verbose&&console.info("Action.before()",this.name,{action:this,target:b,data:c}),a.setCssClass(b,m.cssClass.loading),a.reflectCssClass(this.name,m.cssClass.loading),Object.assign(m.eventBefore.detail,{name:this.name,data:c,model:this.model}),b.dispatchEvent(m.eventBefore)}},{key:"after",value:function after(b,c,d,e){m.verbose&&console.info("Action.after()",this.name,{action:this,target:b,data:e,success:c,result:d}),this.running=!1;var f=c?m.cssClass.success:m.cssClass.fail;return a.setCssClass(b,f),a.reflectCssClass(this.name,f),null!=d&&this.syncModel(d),Object.assign(m.eventAfter.detail,{name:this.name,success:c,data:e,model:this.model}),b.dispatchEvent(m.eventAfter),d}// #region Static methods
...
verbose:!1,viewClass:null,viewMap:{},actionVerb:{get:"fetch",post:"create",patch:"update",delete:"delete"},actionHandler:{get:this.actionHandler,post:this.actionHandler,patch:this.actionHandler,delete:this.actionHandler}},b(this.options,c||{}),this._model=new j,this._model._paging={},this.options.types instanceof Array){var d={};// Turn them into seperate stores
for(var e in this.options.types)d[this.options.types[e]]=this.options.types[e];this.options.types=d}if(this.options.types instanceof Object)for(var f in this.options.types)this.modelCreate(this.options.types[f]);a.cache(this)}return _createClass(a,[{key:"body",value:function body(a){return JSON.stringify(a)}},{key:"model",value:function model(a){return this._model[a]}},{key:"modelCreate",value:function modelCreate(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:null;if("string"!=typeof a)throw new Error("Store: Cannot create model without `type`");this._model[a]||(this._model[a]=new j({},{model:this._model,property:a}),this.actionCreate(a,"get"),this.actionCreate(a,"post"),this.actionCreate(a,"patch"),this.actionCreate(a,"delete"),this.options.viewClass&&this.options.viewMap.hasOwnProperty(a)&&new this.options.viewClass(this.options.viewMap[a],this._model[a])),null==b||"string"!=typeof b&&"number"!=typeof b||this._model[a][b]||(this._model[a][b]=new j({},{model:this._model[a],property:b}))}},{key:"actionCreate",value:function actionCreate(a,b){b=b.toLowerCase();var c=a+" "+this.options.actionVerb[b],d=this.options.actionHandler[b].bind(this,a,b),e=new k(c,d);return k.cache(e),e}},{key:"actionHandler",value:function actionHandler(a,b,c,d,e){var f=null;return"get"===b?f=this.fetch(a,e.id):"post"===b?f=this.post(a,e):"patch"===b?promuse=this.patch(a,e):"delete"===b?f=this.delete(a,e.id):void 0,f.then(function(a){return c(a)}).catch(function(a){return d(a)})}},{key:"data",value:function data(a){return this.options.keys.data?a[this.options.keys.data]:a}},{key:"type",value:function(a){var b=a[this.options.keys.type];return this.options.types[b]&&(b=this.options.types[b]),b}},{key:"id",value:function id(a){return a[this.options.keys.id]}},{key:"sync",value:function sync(a,b){var c=this.data(a);if(!c)throw new Error("Store: No data to sync");if(c instanceof Array){var f={};for(var g in c){var h=null;this.options.keys.data?(h={},h[this.options.keys.data]=c[g]):h=c[g],f[this.id(c[g])]=this.sync(h,b)}return f}var d=this.type(c),e=this.id(c);if(this._model[d]||this.modelCreate(d),this._model[d][e]||this.modelCreate(d,e),!this._model[d][e])throw new Error("Store: No model for type: "+d+", id: "+e);return this._model[d][e].sync(c),b&&(!this._model[d][e].hasOwnProperty("_store")&&(this._model[d][e]._store={url:[]}),-1==this._model[d][e]._store.url.indexOf(b)&&this._model[d][e]._store.url.push(b),b=this.url({type:d,id:e}),-1==this._model[d][e]._store.url.indexOf(b)&&this._model[d][e]._store.url.push(b)),this._model[d][e]}},{key:"url",value:function(a){var b=this.options.types[a.type]||a.type,c=this.options.baseUrl+"/"+b+"/"+(a.id?a.id+"/":""),d=new URLSearchParams;for(var f in a)f in this.options.query?d.set(this.options.query[f],a[f]):"type"!=f&&"id"!=f&&d.set(f,a[f]);var e=d.toString();return e&&(c+="?"+e),c}},{key:"search",value:function search(a){var b=new j;for(var e in this._model)if(!("_paging"==e||a.type&&this.type({type:a.type})!=e))for(var f in this._model[e]){var c=!0,d=this.data(this._model[e][f]);for(var g in a)if("type"!=g&&(!d.hasOwnProperty(g)||d[g]!=a[g])){c=!1;break}c&&(b[f]=d)}return b}},{key:"fetch",value:function(a){function b(){return a.apply(this,arguments)}return b.toString=function(){return a.toString()},b}(/*#__PURE__*/function(){var a=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function c(a,b){var d,e,f,g,h,i,j=arguments;return regeneratorRuntime.wrap(function(c){for(;;)switch(c.prev=c.next){case 0:if(d=2<j.length&&void 0!==j[2]?j[2]:{},a=this.type({type:a}),"object"==_typeof(b)&&(d=b,b=d.id),Object.assign(d,{type:a,id:b}),e=this.url(d),!this._model[a]){c.next=18;break}if(null==b||!this._model[a][b]||this._model[a][b].hasOwnProperty("_store")&&-1==this._model[a][b]._store.url.indexOf(e)){c.next=10;break}return c.abrupt("return",Promise.resolve(this._model[a][b]));case 10:if(null!=b||0!=Object.keys(d).length){c.next=14;break}return c.abrupt("return",Promise.resolve(this._model[a]));case 14:if(null!=b){c.next=18;break}if(f=this.search(d),!Object.keys(f).length){c.next=18;break}return c.abrupt("return",Promise.resolve(f));case 18:return this.options.verbose&&console.info("Store.fetch()",a,b,{type:a,id:b,query:d,store:this,url:e,options:this.options.fetch}),c.prev=19,c.next=22,fetch(e,this.options.fetch);case 22:return g=c.sent,c.next=25,g.json();case 25:return h=c.sent,i=g.ok?h:Promise.reject(h),c.abrupt("return",this.sync(i,e));case 30:return c.prev=30,c.t0=c["catch"](19),this.options.triggerChangesOnError&&this.model(a).triggerChanges(),c.next=35,Promise.reject(c.t0);case 35:return c.abrupt("return",c.sent);case 36:case"end":return c.stop();}},c,this,[[19,30]])}));return function(){return a.apply(this,arguments)}}())},{key:"page",value:function page(a){var b=this,c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1,d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0;d=parseInt(d)||this.options.per_page,c=parseInt(c)||1;var e=this._model._paging;if(a in e&&d in e[a]&&c in e[a][d])return Promise.resolve().then(function(){return e[a][d][c]});a in e||(e[a]={}),d in e[a]||(e[a][d]={}),c in e[a][d]||(e[a][d][c]=new j({type:a,number:c,size:d,count:0,links:{},model:new j}));var f=this.url({type:a,"page[number]":c,"page[size]":d});return this.options.verbose&&console.info("Store.page()",a,c,d,{type:a,page:c,size:d,store:this,url:f,options:options}),fetch(f,this.options.fetch).then(function(a){return a.json().then(function(b){return a.ok?b:Promise.reject(b)})}).then(function(f){return e[a][d][c].sync({links:f.links||{},count:Object.keys(b.data(f)).length,model:b.sync(f)})})}},{key:"post",value:function post(a,b){var c=this,d=Object.create(this.options.fetch);d.method="POST",a=a||this.type(b);var e=this.url({type:a,id:this.id(b)});return this.options.verbose&&console.info("Store.post()",a,{type:a,data:b,store:this,url:e,options:d}),fetch(e,d).then(function(a){return a.json().then(function(b){return a.ok?b:Promise.reject(b)})}).then(function(a){return c.sync(a)}).catch(function(b){return c.options.triggerChangesOnError&&c.model(a).triggerChanges(),Promise.reject(b)})}},{key:"patch",value:function patch(a,b){var c=this,d=Object.create(this.options.fetch);d.method="PATCH",d.body=this.body(b),a=a||this.type(b);var e=this.url({type:a,id:this.id(b)});return this.options.verbose&&console.info("Store.patch()",a,{type:a,data:b,store:this,url:e,options:d}),fetch(e,d).then(function(a){return a.json().then(function(b){return a.ok?b:Promise.reject(b)})}).then(function(a){return c.sync(a)}).catch(function(b){return c.options.triggerChangesOnError&&c.model(a).triggerChanges(),Promise.reject(b)})}},{key:"delete",value:function _delete(a,b){var c=this,d=Object.create(this.options.fetch);d.method="DELETE";var e=this.url({type:a,id:b});return this.options.verbose&&console.info("Store.delete()",a,b,{type:a,id:b,store:this,url:e,options:d}),fetch(e,d).then(function(a){return a.json().then(function(b){return a.ok?b:Promise.reject(b)})}).then(function(d){return delete c._model[a][b],d}).catch(function(b){return c.options.triggerChangesOnError&&c.model(a).triggerChanges(),Promise.reject(b)})}}],[{key:"cache",value:function cache(a){if(null==a)return q;if("string"==typeof a){if(a=a.toLowerCase(),null!=q[a])return q[a];// Find a store that starts with the requested url to match ('/api/v1/entity' with a '/api/v1' store)
