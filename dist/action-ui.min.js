...
}]),c}(t),w={};v.options=t.options,v.options.extension="hbs";var x=/*#__PURE__*/function(){function a(){_classCallCheck(this,a)}return _createClass(a,null,[{key:"start",value:function start(){window.addEventListener("popstate",this.onPopState.bind(this)),z.interceptLinks&&document.addEventListener("click",this.onClick.bind(this)),this.navigate(location.pathname)}},{key:"navigate",value:function navigate(a){var c=this,d=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};z.verbose&&console.info("Router.navigate()",{router:this,route:a,data:d});var f=this.sanitizePath(a),g=f[0],h=f[1],i=this.controllerName(g),j={data:d};this.controllers[i]||(g=z.defaultController,i=this.controllerName(g),h="/"==a?z.defaultMethod:f[0]),y[i]||(this.controllers[i]?y[i]=new this.controllers[i](this.view):y[i]=new l(this.view)),h=h||z.defaultMethod;var k=null,m=g+z.pathSeparator+h,n=e(h);y[i].view instanceof t?y[i].view.file=m:y[i].view instanceof v&&(y[i].view.html=m),z.autoload&&!(y[i][n]instanceof Function)&&(n=z.autoloadMethod),j.dev=location.host==z.devHost,j.view=m,j.controller=g,j.method=h,j.path=Array.from(f);// Query string to object
var o=location.search.substring(1);o&&(o=JSON.parse("{\""+decodeURI(o).replace(/"/g,"\\\"").replace(/&/g,"\",\"").replace(/=/g,"\":\"")+"\"}"),j.search=o);try{var p=Array.from(f);p.shift(),p.shift(),p.push(o),p.push(d),y[i].view.model.clear().sync(j).clearChanges(),k=y[i][n].apply(y[i],p)}catch(a){k=this.handleError(i,j,f)}if(location.pathname!=a&&(b(this.state,{route:a,controller:g,method:h,data:Object.assign({},d),search:o}),history.pushState(this.state,null,a)),k instanceof Promise){var q=document.querySelectorAll("[ui-view=\""+this.view.name+"\"]");this.handleLoading(q,!0),k.then(function(){return c.handleLoading(q,!1)}).catch(function(a){throw c.handleLoading(q,!1),c.handleError(i,j,f,a),a})}return k}},{key:"handleLoading",value:function handleLoading(a,b){return b?a.forEach(function(a){return a.classList.add(z.cssClass.loading)}):a.forEach(function(a){return a.classList.remove(z.cssClass.loading)}),this}},{key:"handleError",value:function handleError(a,b,c,d){return b.error=d,b.view=b.controller+z.pathSeparator+z.errorView,b.path=c.join(z.pathSeparator),y[a].view instanceof t?y[a].view.file=(z.useControllerErrorViews?b.controller+z.pathSeparator:"")+z.errorView:y[a].view.html="Error loading "+b.path,y[a].view.model.clear().sync(b).clearChanges(),y[a][z.errorMethod]()}},{key:"sanitizePath",value:function sanitizePath(a){for(var b in z.verbose&&console.info("Router.sanitizePath()",{router:this,path:a}),"string"==typeof a&&(a=a.split("/"),a.shift(),a[0]=a[0]||z.defaultController),a)a[b]=(a[b]+"").toLowerCase();return 1==a.length&&a.push(z.defaultMethod),a}},{key:"controllerName",value:function controllerName(a){return z.verbose&&console.info("Router.controllerName()",{router:this,name:a}),d(e(a))+"Controller"}},{key:"onClick",value:function onClick(a){"A"==a.target.tagName&&a.target.pathname&&(a.preventDefault(),this.navigate(a.target.pathname,Object.assign({},a.target.dataset)))}},{key:"onPopState",value:function onPopState(a){z.verbose&&console.info("Router.changeState()",{router:this,event:a});var b=location.pathname,c={};a.state&&(b=a.state.route,c=a.state.data),this.navigate(b,c)}// #region Properties
