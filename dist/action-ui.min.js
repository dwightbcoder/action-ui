...
}],[{key:"init",value:function init(){document.addEventListener("click",function(b){var c=f(b.target,"[ui-action]");if(c&&"FORM"!=c.tagName){"INPUT"==c.tagName&&"checkbox"==c.type||b.preventDefault();var d=c.getAttribute("ui-action");// Don't run the action if it's already running
...
var f=b;for(var g in b=new j,f)b[f[g]]=new j}return b._paging={},e=d.call(this,b),e.baseUrl=a,e}_inherits(c,a);var d=_createSuper(c);return _createClass(c,[{key:"sync",value:function sync(a){if(!a.hasOwnProperty("data"))throw new Error("JsonApi: No data to sync");if(a.data instanceof Array){var e={};for(var f in a.data)e[a.data[f].id]=this.sync({data:a.data[f]});return e;//this[json.data[0].type]
            ...
            */}}]),c}(j),p=/*#__PURE__*/function(){function a(c){_classCallCheck(this,a),this.options={baseUrl:null,types:null,keys:{data:null,type:"type",id:"id"},per_page:0,query:{"page[number]":"page[number]","page[size]":"page[size]"},fetch:{method:"GET",headers:new Headers({"Content-Type":"application/json"}),mode:"no-cors"},triggerChangesOnError:!0,// Allows views to update contents on failed requests, especially useful for Fetch All requests which return no results or 404
verbose:!1},b(this.options,c||{});var d=new j;// Accept an array of store keys
if(d._paging={},this.options.types instanceof Array){var e={};// Turn them into seperate stores
for(var f in this.options.types)e[this.options.types[f]]=this.options.types[f];this.options.types=e}if(this.options.types instanceof Object)for(var g in this.options.types)d[this.options.types[g]]=new j({},{model:d,property:this.options.types[g]});this._cache=d}return _createClass(a,[{key:"body",value:function body(a){return JSON.stringify(a)}},{key:"model",value:function model(a){return this._cache[a]}},{key:"data",value:function data(a){return this.options.keys.data?a[this.options.keys.data]:a}},{key:"type",value:function(a){var b=a[this.options.keys.type];return this.options.types[b]&&(b=this.options.types[b]),b}},{key:"id",value:function id(a){return a[this.options.keys.id]}},{key:"sync",value:function sync(a){var b=this.data(a);if(!b)throw new Error("Store: No data to sync");if(b instanceof Array){var e={};for(var f in b){var g=null;this.options.keys.data?(g={},g[this.options.keys.data]=b[f]):g=b[f],e[this.id(b[f])]=this.sync(g)}return e}var c=this.type(b),d=this.id(b);return this._cache[c]||(this._cache[c]=new j({},{model:this._cache,property:c})),this._cache[c][d]||(this._cache[c][d]=new j({},{model:this._cache[c],property:d})),this._cache[c][d].sync(b),this._cache[c][d]}},{key:"url",value:function(a){var b=this.options.types[a.type]||a.type,c=this.options.baseUrl+"/"+b+"/"+(a.id?a.id+"/":""),d=[];for(var f in a)f in this.options.query?d.push(this.options.query[f]+"="+a[f]):"type"!=f&&"id"!=f&&d.push(f+"="+a[f]);var e=d.join("&");return e&&(c+="?"+e),c}},{key:"search",value:function search(a){var b=new j;for(var e in this._cache)if(!("_paging"==e||a.type&&this.type({type:a.type})!=e))for(var f in this._cache[e]){var c=!0,d=this.data(this._cache[e][f]);for(var g in a)if("type"!=g&&(!d.hasOwnProperty(g)||d[g]!=a[g])){c=!1;break}c&&(b[f]=d)}return b}},{key:"fetch",value:function(a){function b(){return a.apply(this,arguments)}return b.toString=function(){return a.toString()},b}(function(a,b){var c=this,d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};if(a=this.type({type:a}),"object"==_typeof(b)&&(d=b,b=d.id),this._cache[a]){if(null!=b&&this._cache[a][b])return Promise.resolve(this._cache[a][b]);if(null==b&&0==Object.keys(d).length)return Promise.resolve(this._cache[a]);if(null==b){d.type=a;var f=this.search(d);if(Object.keys(f).length)return Promise.resolve(f)}}Object.assign(d,{type:a,id:b});var e=this.url(d);return fetch(e,this.options.fetch).then(function(a){return a.ok?a.json():Promise.reject(a)}).then(function(a){return c.sync(a)}).catch(function(b){return c.options.triggerChangesOnError&&c.model(a).triggerChanges(),Promise.reject(b)})})},{key:"page",value:function page(a){var b=this,c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1,d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0;d=parseInt(d)||this.options.per_page,c=parseInt(c)||1;var e=this._cache._paging;if(a in e&&d in e[a]&&c in e[a][d])return Promise.resolve().then(function(){return e[a][d][c]});a in e||(e[a]={}),d in e[a]||(e[a][d]={}),c in e[a][d]||(e[a][d][c]=new j({type:a,number:c,size:d,count:0,links:{},model:new j}));var f=this.url({type:a,"page[number]":c,"page[size]":d});return fetch(f,this.options.fetch).then(function(a){return a.ok?a.json():Promise.reject(a)}).then(function(f){return e[a][d][c].sync({links:f.links||{},count:Object.keys(b.data(f)).length,model:b.sync(f)})})}},{key:"post",value:function post(a,b){var c=this,d=Object.create(this.options.fetch);d.method="POST",a=a||this.type(b);var e=this.url({type:a,id:this.id(b)});return fetch(e,d).then(function(a){return a.json()}).then(function(a){return c.sync(a)})}},{key:"patch",value:function patch(a,b){var c=this,d=Object.create(this.options.fetch);d.method="PATCH",d.body=this.body(b),a=a||this.type(b);var e=this.url({type:a,id:this.id(b)});return fetch(e,d).then(function(a){return a.json()}).then(function(a){return c.sync(a)})}},{key:"delete",value:function _delete(a,b){var c=this,d=Object.create(this.options.fetch);d.method="DELETE";var e=this.url({type:a,id:b});return this.options.verbose&&console.info("Store.delete()",a,b,{store:this,url:e,options:d}),fetch(e,d).then(function(a){return a.ok?a.json():Promise.reject(a)}).then(function(d){return delete c._cache[a][b],d})}}]),a}(),q=/*#__PURE__*/function(a){function c(a){_classCallCheck(this,c);var e={keys:{data:"data",type:"type",id:"id"},query:{"page[number]":"page[number]","page[size]":"page[size]"},per_page:0,fetch:{headers:new Headers({"Content-Type":"application/vnd.api+json"})}};return b(e,a||{}),d.call(this,e)}_inherits(c,a);var d=_createSuper(c);return _createClass(c,[{key:"sync",value:function sync(a){if(a.included){var b=this.options.keys.data;this.options.keys.data="included",_get(_getPrototypeOf(c.prototype),"sync",this).call(this,a),this.options.keys.data=b}return _get(_getPrototypeOf(c.prototype),"sync",this).call(this,a)}},{key:"body",value:function body(a){return JSON.stringify({data:a})}}]),c}(p),r=/*#__PURE__*/function(a){function c(a){_classCallCheck(this,c);var e={baseUrl:"/wp-json/wp/v2",types:{page:"pages",post:"posts",category:"categories",tag:"tags",comment:"comments"},keys:{data:null,type:"type",id:"id"},query:{"page[number]":"page","page[size]":"per_page"},per_page:10};return b(e,a||{}),d.call(this,e)}_inherits(c,a);var d=_createSuper(c);return _createClass(c,[{key:"fetch",value:function fetch(a,b){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};return"string"==typeof b&&(d.slug=b,b=void 0),_get(_getPrototypeOf(c.prototype),"fetch",this).call(this,a,b,d)}}]),c}(p),s=/*#__PURE__*/function(){function a(b,c,d){var e=this;_classCallCheck(this,a),d instanceof j||(d=new j(d||{controller:null,data:{},dev:!1,error:null,method:null,path:null,view:null})),this._name=b,this._html=c,this._model=d,d.watch(function(a){return e.update(a)}),this.constructor.options.autoCache&&a.cache(this)}return _createClass(a,[{key:"clear",value:function clear(){return document.querySelectorAll("[ui-view=\""+this._name+"\"]").forEach(function(a){a.innerHTML=""}),this}// When the model updates
...
}],[{key:"options",get:function get(){return y},set:function set(a){b(y,a)}// #endregion
}]),c}(v),y={};x.options=v.options,x.options.extension="hbs";var z=/*#__PURE__*/function(){function a(){_classCallCheck(this,a)}return _createClass(a,null,[{key:"start",value:function start(){window.addEventListener("popstate",this.onPopState.bind(this)),B.interceptLinks&&document.addEventListener("click",this.onClick.bind(this)),this.navigate(location.pathname)}},{key:"route",value:function route(a,b){var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0;this.options.routes[a]={route:a,callback:b,priority:c}}},{key:"match",value:function match(a){var b=!(1<arguments.length&&void 0!==arguments[1])||arguments[1];// Exact match
...
return c&&b&&"string"==typeof c.callback&&(c=this.match(c.callback)),c}},{key:"navigate",value:function navigate(a){var b=this,c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:null;B.verbose&&console.info("Router.navigate()",{router:this,route:a,data:c});var f=this.sanitizePath(a),g=f[0],h=f[1],i=this.controllerName(g),j={data:c},l=this.match(a,!1);if(l&&"string"==typeof l.callback)// Redirect
return this.navigate(l.callback,c,d);this.controllers[i]||(g=B.defaultController,i=this.controllerName(g),h="/"==a?B.defaultMethod:f[0]),A[i]||(this.controllers[i]?A[i]=new this.controllers[i](this.view):A[i]=new n(this.view)),h=h||B.defaultMethod;var m=null,o=g+B.pathSeparator+h,p=e(h);A[i].view instanceof v?A[i].view.file=o:A[i].view instanceof x&&(A[i].view.html=o),B.autoload&&!(A[i][p]instanceof Function)&&(p=B.autoloadMethod),j.dev=location.host==B.devHost,j.view=o,j.controller=g,j.method=h,j.path=Array.from(f),j.event=d;// Query string to object
var q=location.search.substring(1);q&&(q=JSON.parse("{\""+decodeURI(q).replace(/"/g,"\\\"").replace(/&/g,"\",\"").replace(/=/g,"\":\"")+"\"}"),j.search=q);try{var r=Array.from(f);if(r.shift(),r.shift(),r.push(q),r.push(c),!l)A[i].view.model.clear().sync(j).clearChanges(),m=A[i][p].apply(A[i],r),this.pushState(a,{controller:g,method:h,data:Object.assign({},c),search:q});else if(l.callback instanceof k){l.callback.model.clear().sync(j).clearChanges();var s=d?d.target:document;m=l.callback.run(s,c)}else r.push(j),m=l.callback.apply(A[i],r)}catch(b){this.options.verbose&&console.error("Routing Error",b),this.pushState(a,{controller:g,method:h,data:Object.assign({},c),search:q}),m=this.handleError(i,j,f)}if(m instanceof Promise){var t=document.querySelectorAll("[ui-view=\""+this.view.name+"\"]");this.handleLoading(t,!0),m.then(function(){return b.handleLoading(t,!1)}).catch(function(a){throw b.handleLoading(t,!1),b.handleError(i,j,f,a),a})}return m}},{key:"handleLoading",value:function handleLoading(a,b){return b?a.forEach(function(a){return a.classList.add(B.cssClass.loading)}):a.forEach(function(a){return a.classList.remove(B.cssClass.loading)}),this}},{key:"handleError",value:function handleError(a,b,c,d){return b.error=d,b.view=b.controller+B.pathSeparator+B.errorView,b.path=c.join(B.pathSeparator),A[a].view instanceof v?A[a].view.file=(B.useControllerErrorViews?b.controller+B.pathSeparator:"")+B.errorView:A[a].view.html="Error loading "+b.path,A[a].view.model.clear().sync(b).clearChanges(),A[a][B.errorMethod]()}},{key:"sanitizePath",value:function sanitizePath(a){for(var b in B.verbose&&console.info("Router.sanitizePath()",{router:this,path:a}),"string"==typeof a&&(a=a.split("/"),a.shift(),a[0]=a[0]||B.defaultController),a)a[b]=(a[b]+"").toLowerCase();return 1==a.length&&a.push(B.defaultMethod),a}},{key:"controllerName",value:function controllerName(a){return B.verbose&&console.info("Router.controllerName()",{router:this,name:a}),d(e(a))+"Controller"}},{key:"pushState",value:function pushState(a){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};location.pathname!=a&&(c.route=a,b(this.state,c),history.pushState(this.state,null,a))}},{key:"onClick",value:function onClick(a){"A"==a.target.tagName&&a.target.pathname&&(a.preventDefault(),this.navigate(a.target.pathname,Object.assign({},a.target.dataset),a))}},{key:"onPopState",value:function onPopState(a){B.verbose&&console.info("Router.changeState()",{router:this,event:a});var b=location.pathname,c={};a.state&&(b=a.state.route,c=a.state.data),this.navigate(b,c)}// #region Properties
},{key:"controllers",get:function get(){return this.options.controllers},set:function set(a){this.options.controllers=a}},{key:"state",get:function get(){return this.options.state},set:function set(a){this.options.state=a}},{key:"view",get:function get(){return this.options.view instanceof s||(this.view=this.options.view),this.options.view},set:function set(a){this.options.view=a instanceof s?a:new v(a)}},{key:"options",get:function get(){return B},set:function set(a){b(B,a)}// #endregion
}]),a}(),A={},B={controllers:{},view:"controller",state:{},autoload:!0,verbose:!1,cssClass:{loading:"loading",success:"success",fail:"fail"},defaultController:"default",autoloadMethod:"__autoload",defaultMethod:"index",errorMethod:"__error",errorView:"error",useControllerErrorViews:!1,devHost:"localhost",interceptLinks:!0,pathSeparator:"/",routes:{}};return a.Action=k,a.Controller=n,a.JsonApi=o,a.Model=j,a.Router=z,a.Store=p,a.StoreJsonApi=q,a.StoreWordpress=r,a.Util=i,a.View=s,a.ViewFile=v,a.ViewHandlebars=x,a}({});