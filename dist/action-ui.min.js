...
o.url+=(0>o.url.indexOf("?")?"?":"&")+Object.keys(t).map(e=>e+"="+t[e]).join("&"));else if(e.attributes.enctype&&"application/json"==e.attributes.enctype.value)o.body=JSON.stringify(t);else{let e=new FormData;for(let o in t)e.append(o,t[o]);o.body=e}this.handler=new Request(o.url,o)}n=fetch(this.handler).then(e=>e.json().then(t=>e.ok?t:Promise.reject(t)))}return n.then(o=>this.after(e,!0,o,t),o=>this.after(e,!1,o,t))}syncModel(e){return e=t({},e,!0),m.verbose&&console.info("Action.syncModel()",this.name,{action:this,data:e}),e instanceof Object||(e={result:e}),this.model.sync&&this.model.sync instanceof Function?this.model.sync(e):this.model instanceof Object&&t(this.model,e),e}before(e,t){m.verbose&&console.info("Action.before()",this.name,{action:this,target:e,data:t}),c.setCssClass(e,m.cssClass.loading,t),c.reflectCssClass(this.name,m.cssClass.loading,t);let o=new CustomEvent(m.eventBefore.type,m.eventBefore);return Object.assign(o.detail,{name:this.name,data:t,model:this.model}),m.eventTargetFallbackToDocument&&!document.body.contains(e)?document.dispatchEvent(eventAfter):e.dispatchEvent(o)}after(e,t,o,n){m.verbose&&console.info("Action.after()",this.name,{action:this,target:e,data:n,success:t,result:o}),this.running=!1;var a=o instanceof u,i=t?m.cssClass.success:m.cssClass.fail;a&&(i=m.cssClass.canceled),c.setCssClass(e,i,n),c.reflectCssClass(this.name,i,n),null==o||o instanceof Error||this.syncModel(o);let s=new CustomEvent(m.eventAfter.type,m.eventAfter);return Object.assign(s.detail,{name:this.name,success:t,data:n,model:this.model,error:!!(o instanceof Error)&&o,canceled:a}),m.eventTargetFallbackToDocument&&!document.body.contains(e)?(m.verbose&&console.warn("Action.after() target element missing from DOM",{target:e}),document.dispatchEvent(s)):e.dispatchEvent(s),o}// #region Static methods
...
if(o in y)!1==y[o].running&&y[o].run(e);else if(m.autoCreate){// Auto create and run action
...
if(e in y)!1==y[e].running&&y[e].run(t.target);else if(m.autoCreate){// Auto create and run action
var o=c.createFromElement(t.target);c.cache(o),o.run(t.target)}else throw new Error("Action not found: "+e)}})}static create(e,t=!0){if(m.verbose&&console.info(this.name+":create()",{options:e,fromCache:t}),!1=="name"in e)throw"No action name specfied";return!1=="handler"in e&&(!0=="url"in e&&e.url?e.handler=new Request(e.url,e.request||{}):e.handler=null),t?this.cache(e.name)||new this(e.name,e.handler,e.model):new this(e.name,e.handler,e.model)}static createFromElement(e,t={}){return c.create(Object.assign({name:e.getAttribute("ui-action")||null,url:e.action||e.href||t.href||null,request:{method:e.method||t.method||"GET"}},t))}// Cache an action 
static cache(e){return null==e?y:"string"==typeof e?y[e]:e.name in y?this:(y[e.name]=e,this)}static data(e){var t=e.dataset||{},o=n(e);return o&&(t=r(o,t)),t}static get(e){return y[e]}static setCssClass(e,t,o=null){if(!e.attributes["ui-nostate"]){if(null!=o&&!!e.attributes["ui-state-data"]){let t=!0,n=JSON.parse(e.attributes["ui-state-data"].value);for(let e in n)if(t=o[e]==n[e],!1===t)break;if(!1==t)return}for(var n in m.cssClass)e.classList.remove(m.cssClass[n]);e.classList.add(t)}}// Propagate class to all reflectors (ui-state and form submit buttons)
static reflectCssClass(e,t,o=null){document.querySelectorAll("form[ui-action=\""+e+"\"] [type=\"submit\"], form[ui-action=\""+e+"\"] button:not([type]), [ui-state=\""+e+"\"]").forEach(e=>c.setCssClass(e,t,o))}static get options(){return m}static set options(e){t(m,e)}// #endregion
}class u extends Error{}let y={},m={verbose:!1,autoCreate:!0,autoCache:!0,cssClass:{loading:"loading",success:"success",fail:"fail",canceled:"canceled"},eventTargetFallbackToDocument:!0,eventBefore:new CustomEvent("action.before",{bubbles:!0,cancelable:!0,detail:{type:"before",name:null,data:null,model:null}}),eventAfter:new CustomEvent("action.after",{bubbles:!0,cancelable:!0,detail:{type:"after",name:null,data:null,success:null,model:null}})};c.init();/**
	 * Controller
	 * Provider route mapping for SPAs
	 */class g{constructor(e){this.view=e}__autoload(){return this.view.render()}__error(){return this.view.render()}get view(){return this._view}set view(e){this._view=e}}/**
	 * JsonApi
...
for(var t in _)if(t.startsWith(e))return _[t];return}var o=e.options.baseUrl.toLowerCase();return o in _?this:(_[o]=e,this)}}class f extends Error{}let _={};/**
	 * View
	 ...
	 */class v{constructor(e,t,o){o instanceof l||(o=new l(o||{controller:null,data:{},dev:!1,error:null,method:null,path:null,view:null})),this._name=e,this._html=t,this._model=o,o.watch(e=>this.update(e)),this.constructor.options.autoCache&&v.cache(this)}clear(){return document.querySelectorAll("[ui-view=\""+this._name+"\"]").forEach(e=>{e.innerHTML=""}),this}// When the model updates
...
static cache(e){if(this.options.verbose&&console.info(this.name+":cache()",{view:e}),"string"==typeof e)return b[e];if(e instanceof v){if(e.name in b)throw"View name already exists: \""+e.name+"\"";return b[e.name]=e,this}return b}// Render all views
static get options(){return C}static set options(e){t(C,e)}// #endregion
}let b={},C={verbose:!1,autoCache:!0,// Automatically cache views when created
