...
}function o(e,o){return t(e,o,!0)}function n(e){return"FORM"==e.tagName?e:e.form}function a(e){return e[0].toUpperCase()+e.substr(1).toLowerCase()}function i(e){return e.toLowerCase().replace(/[^a-zA-Z0-9]+(.)/g,(e,t)=>t.toUpperCase())}function s(e,t){return null==e||e.matches(t)?e:s(e.parentElement,t)}function r(e,o={}){const n=new FormData(e);return o=Object.assign(Object.fromEntries(n),o),Object.entries(o).map(e=>{const a=e[0].split("[").map(e=>e.replace(/]/g,""));if(e[0].endsWith("[]"))o[a[0]]=n.getAll(e[0]),delete o[e[0]];else if(1<a.length){const n=p(a,e[1]);t(o,n),delete o[e[0]]}return e}),o}function p(e,t,o){const n=e.pop();if(!n)return o;let a={};return a[n]=o?o:t,p(e,t,a)}var d=/*#__PURE__*/Object.freeze({__proto__:null,deepAssign:t,deepCopy:o,requestFromElement:function(e){return new Request(e.action||options.href||null,{method:e.method||null})},form:n,capitalize:a,camelCase:i,firstMatchingParentElement:s,formToObject:r});/**
	 * Model
	 * @version 20230914
...
static cache(e){return null==e?m:"string"==typeof e?m[e]:e.name in m?this:(m[e.name]=e,this)}static data(e){var t=e.dataset||{},o=n(e);return o&&(t=r(o,t)),t}static get(e){return m[e]}static setCssClass(e,t,o=null){if(!e.attributes["ui-nostate"]){if(null!=o&&!!e.attributes["ui-state-data"]){let t=!0,n=JSON.parse(e.attributes["ui-state-data"].value);for(let e in n)if(t=o[e]==n[e],!1===t)break;if(!1==t)return}for(var n in h.cssClass)e.classList.remove(h.cssClass[n]);e.classList.add(t)}}// Propagate class to all reflectors (ui-state and form submit buttons)
