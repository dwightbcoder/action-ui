...
static init(){document.addEventListener("click",t=>{let e=s(t.target,"[ui-action]"),o=e.disabled||t.target.disabled||e.hasAttribute("disabled")||t.target.hasAttribute("disabled");if(e&&"FORM"!=e.tagName&&!o){"INPUT"==e.tagName&&("checkbox"==e.type||"radio"==e.type)||t.preventDefault();var n=e.getAttribute("ui-action");// Don't run the action if it's already running
