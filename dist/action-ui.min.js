...
}],[{key:"init",value:function init(){document.addEventListener("click",function(b){var c=f(b.target,"[ui-action]");if(c&&"FORM"!=c.tagName){b.preventDefault();var d=c.getAttribute("ui-action");// Don't run the action if it's already running
