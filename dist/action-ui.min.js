...
if(o in g)!1==g[o].running&&g[o].run(e);else if(h.autoCreate){// Auto create and run action
...
if(e in g)!1==g[e].running&&g[e].run(t.target);else if(h.autoCreate){// Auto create and run action
...
static cache(e){return null==e?g:"string"==typeof e?g[e]:e.name in g?this:(g[e.name]=e,this)}static data(e){var t=e.dataset||{},o=n(e);return o&&(t=r(o,t)),t}static get(e){return g[e]}static setCssClass(e,t,o=null){if(!e.attributes["ui-nostate"]){if(null!=o&&!!e.attributes["ui-state-data"]){let t=!0,n=JSON.parse(e.attributes["ui-state-data"].value);for(let e in n)if(t=o[e]==n[e],!1===t)break;if(!1==t)return}for(var n in h.cssClass)e.classList.remove(h.cssClass[n]);e.classList.add(t)}}// Propagate class to all reflectors (ui-state and form submit buttons)
...
}class u extends Error{}class y extends Event{constructor(e){super("action.before",{bubbles:!0,cancelable:!0}),this.detail={type:"before",name:null,data:null,model:null},Object.assign(this.detail,e)}}class m extends Event{constructor(e){super("action.after",{bubbles:!0,cancelable:!0}),this.detail={type:"after",name:null,data:null,model:null,success:null,error:null,canceled:null},Object.assign(this.detail,e)}}let g={},h={verbose:!1,autoCreate:!0,autoCache:!0,cssClass:{loading:"loading",success:"success",fail:"fail",canceled:"canceled"},eventTargetFallbackToDocument:!0,eventBefore:y,eventAfter:m};c.init();/**
	 * Controller
