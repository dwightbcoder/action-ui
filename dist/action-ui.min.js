...
if(o in u)!1==u[o].running&&u[o].run(e);else if(g.autoCreate){// Auto create and run action
...
if(e in u)!1==u[e].running&&u[e].run(t.target);else if(g.autoCreate){// Auto create and run action
...
static cache(e){return null==e?u:"string"==typeof e?u[e]:e.name in u?this:(u[e.name]=e,this)}static data(e){var t=e.dataset||{},o=n(e);return o&&(t=r(o,t)),t}static get(e){return u[e]}static setCssClass(e,t,o=null){if(!e.attributes["ui-nostate"]){if(null!=o&&!!e.attributes["ui-state-data"]){let t=!0,n=JSON.parse(e.attributes["ui-state-data"].value);for(let e in n)if(t=o[e]==n[e],!1===t)break;if(!1==t)return}for(var n in g.cssClass)e.classList.remove(g.cssClass[n]);e.classList.add(t)}}// Propagate class to all reflectors (ui-state and form submit buttons)
...
for(var t in _)if(t.startsWith(e))return _[t];return}var o=e.options.baseUrl.toLowerCase();return o in _?this:(_[o]=e,this)}}class f extends Error{}let _={};/**
	 ...
	 */class v{constructor(e,t,o){o instanceof l||(o=new l(o)),this._name=e,this._html=t,this._model=o,o.watch(e=>this.update(e)),this.constructor.options.autoCache&&v.cache(this)}clear(){return document.querySelectorAll("[ui-view=\""+this._name+"\"]").forEach(e=>{e.innerHTML=""}),this}// When the model updates
